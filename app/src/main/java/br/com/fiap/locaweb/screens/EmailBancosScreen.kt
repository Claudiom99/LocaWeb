...
@Composable
fun EmailScreen3(controleGeral: NavController, backStackEntry: NavBackStackEntry) {
    ...
    Box(
        ...
        Column(
            ...
            SearchBar3(controleGeral, backStackEntry)

            // Título da lista de emails com ícone
            TitleWithIcon3(solidColor)

            // Lista de emails
            EmailList3(controleGeral, backStackEntry)

            // Botão "Novo"
            NewEmailButton3(controleGeral, backStackEntry)
...
@Composable
fun SearchBar3(navController: NavController, backStackEntry: NavBackStackEntry) {
...
@Composable
fun EmailList3(navController: NavController, backStackEntry: NavBackStackEntry) {
    val emails = listOf(
...
@Composable
fun EmailItemComponent(email: EmailItem3, navController: NavController, backStackEntry: NavBackStackEntry) {
    val context = LocalContext.current
    val usuarioRepository = UsuarioRepository(context)
...
@Composable
fun NewEmailButton3(controleGeral: NavController, backStackEntry: NavBackStackEntry) {
    val context = LocalContext.current
    val usuarioRepository = UsuarioRepository(context)
