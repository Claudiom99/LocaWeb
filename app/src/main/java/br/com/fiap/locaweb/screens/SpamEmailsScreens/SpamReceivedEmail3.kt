...
@Composable
fun SpamReceivedEmail3() {

    SpamReceivedEmail3(rememberNavController())

}*/

@Composable
fun SpamReceivedEmail3(controleGeral: NavController, backStackEntry: NavBackStackEntry) {
